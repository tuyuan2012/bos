...
<script type="text/javascript">
	...
	$(function(){
		var tag = '${deltag}';
		if(tag == '1'){
			$.messager.alert("提示信息","当前流程定义不能删除！","warning");
		}
	});
</script>
</head>
  	...
  	<table id="grid" class="easyui-datagrid">  
  		<thead>
  			<tr>
  				...
  				<th data-options="field:'viewpng'" width="200">操作</th>
  			</tr>
  		</thead>
  		<tbody>
  				...
  				<tr>
  					...
  					<td>
  						...
  						<script type="text/javascript">
  							function show(id){
  								var sFeatures="dialogHeight: 500px;center:yes;";
  								window.showModalDialog('processDefinitionAction_showpng.action?id='+id,'',sFeatures);
  							}
  						</script>
  						<s:a onclick="return window.confirm('你确定删除当前流程定义吗？');" 
  							 action="processDefinitionAction_delete" namespace="/"
  							 cssClass="easyui-linkbutton" data-options="iconCls:'icon-search'">删除
  							<s:param name="id" value="id"></s:param>
  						</s:a>
  					</td>
  				</tr>
