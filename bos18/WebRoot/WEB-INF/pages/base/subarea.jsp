...
<script type="text/javascript">
	function doAdd(){
		$('#addSubareaWindow').window("open");//打开分区添加窗口
	}
	...
	//导出分区数据到Excel文件中，并提供下载
	function doExport(){
		window.location.href = "${pageContext.request.contextPath}/subareaAction_exportXls.action";//客户端发起get方法请求
	}
						...
						<td colspan="2">
							...
							<script type="text/javascript">
								$(function(){
									...
									$("#btn").click(function(){
										var params = $("#searchForm").serializeJson();//{"name":"abc"}
										//重新发起一次ajax请求
