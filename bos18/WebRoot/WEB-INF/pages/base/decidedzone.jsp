...
<script type="text/javascript">
	...
	function doAssociations(){
		...
		if(rows.length != 1){
			...
			//发送ajax请求，访问Action，在Action调用crm代理对象，查询客户信息，返回json
...
<body class="easyui-layout" style="visibility:hidden;">
	...
	<!-- 关联客户窗口 -->
	<div class="easyui-window" modal="true"
		 title="关联客户窗口" id="customerWindow" collapsible="false" closed="true" 
		...
		<div style="overflow:auto;padding:5px;" border="false">
			<form id="customerForm" action="${pageContext.request.contextPath }/decidedzoneAction_assigncustomerstodecidedzone.action" method="post">
				<table class="table-edit" width="80%" align="center">
					...
					<tr>
						<td colspan="3">
							<a id="associationBtn" href="#" class="easyui-linkbutton" data-options="iconCls:'icon-save'">关联客户</a> </td>
					</tr>
				</table>
			</form>
		</div>
