...
<script type="text/javascript">
	...
	$(function() {
		...
		$("#btnEp").click(function(){
			//判断校验是否成功
			var v = $("#pwdForm").form("validate");//校验表单中的输入项
			if(v){
				//校验通过,手动校验两次输入是否一致
	                ...
	                <table cellpadding=3>
	                    <tr>
	                        ...
	                        <td><input id="txtNewPass" type="Password" 
	                        		required="true" data-options="validType:'length[6,8]'" 
	                        		class="txt01 easyui-validatebox" /></td>
	                    </tr>
	                    <tr>
	                        <td>确认密码：</td>
	                        <td><input id="txtRePass" type="Password" required="true" 
	                        	data-options="validType:'length[6,8]'"  class="txt01 easyui-validatebox" /></td>
	                    </tr>
	                </table>
                </form>
            </div>
